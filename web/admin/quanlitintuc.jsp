...
<%
  ...
  ArrayList<TinTuc> list= tinTucDaoIMP.getListTinTuc();
%>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered">
                ...
                <tr>
                  <td><%=count%></td>
                  <td><%=tinTuc.getMaTinTuc()%></td>
                  <td><%=tinTuc.getTieuDe()%></td>
                  <td><%=tinTuc.getTime()%></td>
                  <td>
                    <div class="row justify-content-center">
                      <a href="<%=Util.utilUser("XoaTinTucServlet")%>?maTinTuc=<%=tinTuc.getMaTinTuc()%>">
                        <button type="button" class="btn btn-block btn-outline-danger">
                          <i class="fa fa-trash-alt"></i>
                        </button>
                      </a>
                      <a href="suatintuc.jsp?maTinTuc=<%=tinTuc.getMaTinTuc()%>">
