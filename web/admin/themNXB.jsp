        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href=<%=Util.utilAdmin("quanlidanhmuc.jsp")%>>Quản lý nhà xuất bản</a></li>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
                <div class=" col-6">
                  <a class="card-title">
                    Điền vào form để thêm nhà xuất bản</a>
                </div>
              </div>
            </div>
            <!-- /.card-header -->
              ...
              <div class="row justify-content-center">
                <div class="col-md-6">
                  <div class="card card-info">
                    ...
                    <div class="card-body">
                      <form role="form" action="http://localhost:8000/PJ/ThemNXBServlet" method="post">
                        <!-- Date dd/mm/yyyy -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="maNhaXuatBan">
                          </div>
                          <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
