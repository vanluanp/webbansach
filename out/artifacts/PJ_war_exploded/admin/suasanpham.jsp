...
<div class="wrapper">
  ...
  <%
    ...
    SanPham sanPham = new SanPhamDaoIMP().getSingleProduct(request.getParameter("maSach"));
  %>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href=<%=Util.utilAdmin("quanlisanpham.jsp")%>>Quản lý sản phẩm</a>
              </li>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
                <div class=" col-6">
                  <a class="card-title">
                    Điền vào form để sửa sản phẩm</a>
                </div>
              </div>
            </div>
            <!-- /.card-header -->
                ...
                <div class="col-md-10">
                  <div class="card card-info">
                    ...
                    <div class="card-body">
                      ...
                      <form role="form" action=<%=Util.utilUser("QLSanPhamServlet")%> method="post">
...
<%--                        </div>--%>
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="tenSach" value="<%=sanPham.getTenSach()%>">
                          </div>
                          <!-- /.input group -->
                        </div>
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="tacGia" value="<%=sanPham.getTacGia()%>">
                          </div>
                          <!-- /.input group -->
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="maNhaXuatBan">
                              <%
                                for (NhaXuatBan nhaXuatBan : danhMucDaoIMP.getListNXB()) {
                                  String selectedNXB = "";
                                  if (nhaXuatBan.getMaNhaXuatBan().equals(sanPham.getNhaXuatBan().getMaNhaXuatBan())) {
                                    selectedNXB = "selected";
                                  }
                              %>
                              <option value="<%=nhaXuatBan.getMaNhaXuatBan()%>"
                                <%=selectedNXB%>><%=nhaXuatBan.getTenNhaXuatBan()%>
                              </option>
                              <%
                                }
                              %>
                        ...
                        <div class="form-group">
                          ...
                          <div class="custom-file">
                            <input type="file" name="hinhAnh1" value="<%=sanPham.getHinhAnh1()%>"><img src="http://localhost:8000/PJ/images/books/book (241).jpg" style="width: 80px" height="100px">
                          </div>
                          <!-- /.input group -->
                        </div>
                        <div class="form-group">
                          ...
                          <div class="custom-file">
                            <input type="file" name="hinhAnh2" value="<%=sanPham.getHinhAnh2()%>"><img src="http://localhost:8000/PJ/images/books1/book (241).jpg" style="width: 80px" height="100px">
                          </div>
                          <!-- /.input group -->
                        </div>
                        <!-- phone mask -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="soLuongBan"
                                   value="<%=sanPham.getSoLuongBan()%>">
                          </div>
                          <!-- /.input group -->
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="giaGoc" value="<%=sanPham.getGiaGoc()%>">
                          </div>
                          <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="custom-file">
                            <input type="file" name="moTa" value="<%=sanPham.getMoTa()%>">
                          </div>
                          <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
                        <div class="form-group">
                          ...
                          <div class="custom-file">
                            <input type="file" name="chiTietMoTa" value="<%=sanPham.getChiTietMoTa()%>">
                          </div>
                          <!-- /.input group -->
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="maLoaiSach">
                              <%
                                for (DanhMuc danhMuc : danhMucDaoIMP.getListConAll()) {
                                  String selectedLoai = "";
                                  if (danhMuc.getMaDanhMuc().equals(sanPham.getDanhMuc().getMaDanhMuc())) {
                                    selectedLoai = "selected";
                                  }
                              %>
                              <option value="<%=danhMuc.getMaDanhMuc()%>"
                                <%=selectedLoai%>><%=danhMuc.getTenDanhMuc()%>
                              </option>
                              <%
                                }
                              %>
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <select class="form-control" name="status">
                              <option value="0" <%=selectedStatus.get(0)%>>Ẩn đi</option>
                              <option value="1" <%=selectedStatus.get(1)%>>Sách</option>
                              <option value="2" <%=selectedStatus.get(2)%>>Slider 1</option>
                              <option value="3" <%=selectedStatus.get(3)%>>Slider 2</option>
                              <option value="4" <%=selectedStatus.get(4)%>>Khuyến mãi</option>
                            </select>
                          </div>
                          <!-- /.input group -->
                        </div>
