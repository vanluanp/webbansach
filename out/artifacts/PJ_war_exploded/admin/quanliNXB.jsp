          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
                <div class=" col-6">
                  <a class="card-title">
                    Bảng quản lý các nhà xuất bản</a>
                </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered">
                ...
                <%
                  int count=0;
                  for(NhaXuatBan list: danhMucDaoIMP.getListNXB()){
                    count++;
                %>
                <tr>
                  <td><%=count%></td>
                  <td><%=list.getMaNhaXuatBan()%></td>
                  <td><%=list.getTenNhaXuatBan()%></td>
                  <td>
                    <div class="row justify-content-center">
                      <a href="/PJ/XoaNXBServlet?maNhaXuatBan=<%=list.getMaNhaXuatBan()%>">
                        <button type="button" class="btn btn-block btn-outline-danger">
                          <i class="fa fa-trash-alt"></i>
                        </button>
                      </a>
                      <a  href="suaNXB.jsp?maNhaXuatBan=<%=list.getMaNhaXuatBan()%>">
