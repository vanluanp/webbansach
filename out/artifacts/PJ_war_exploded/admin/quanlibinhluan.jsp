          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-responsive-md">
                ...
                <%
                  int count=0;
                  for(Review list: reviewDaoIMP.getReviewAll()){
                    count++;
                %>
                <tbody>
                <tr>
                  <td><%=count%></td>
                  <td><%=list.getMaNhanXet()%></td>
                  <td><%=list.getUserName()%></td>
                  <td><%=list.getMaSach()%></td>
                  <td><%=list.getTime()%></td>
                  <td><%=list.getSubject()%></td>
                  <td><%=list.getReview()%></td>
                  <td>
                    <div class="row justify-content-center">
                      <a target="_blank" href="<%=Util.utilUser("QLReviewServlet?maNhanXet=")%><%=list.getMaNhanXet()%>">
