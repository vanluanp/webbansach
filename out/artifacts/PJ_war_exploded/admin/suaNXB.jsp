...
<div class="wrapper">
  ...
  <%
    NhaXuatBan nxb= new DanhMucDaoIMP().getSingleNXB(request.getParameter("maNhaXuatBan"));
    String err = "";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href=<%=Util.utilAdmin("quanliNXB.jsp")%>>Quản lý nhà xuất bản</a></li>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
                <div class=" col-6">
                  <a class="card-title">
                    Điền vào form để sửa nhà xuất bản</a>
                </div>
              </div>
            </div>
            <!-- /.card-header -->
              ...
              <div class="row justify-content-center">
                <div class="col-md-6">
                  <div class="card card-info">
                    <div class="card-header">
                      <h3 class="card-title">Thông tin nhà xuất bản</h3>
                    </div>

                    <div class="card-body">
                      <form role="form" method="post" action="/PJ/SuaNXBServlet">
                        <!-- Date dd/mm/yyyy -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="maNhaXuatBan" value="<%=nxb.getMaNhaXuatBan()%>">
                          </div>
                          <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="tenNhaXuatBan" value="<%=nxb.getTenNhaXuatBan()%>">
                          </div>
                          <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
