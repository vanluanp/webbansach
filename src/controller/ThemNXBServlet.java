...
@WebServlet("/ThemNXBServlet")
public class ThemNXBServlet extends HttpServlet {
...
//            getServletContext().getRequestDispatcher("/admin/quanlisanpham.jsp").forward(request, response);
            if(err.length()==0) {
                ...
                request.getRequestDispatcher("admin/themNXB.jsp").forward(request,response);
            }
        }
    }
